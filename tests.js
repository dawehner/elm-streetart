...
var _user$project$PostTypes$viewPicturePost = function (model) {
	return A2(
		_elm_lang$html$Html$img,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$src(model.url),
				_elm_lang$html$Html_Attributes$title(model.title)
			]),
		_elm_lang$core$Native_List.fromArray(
			[]));
};
var _user$project$PostTypes$viewBlogPost = function (model) {
	return A2(
...
var _user$project$PostTypes$viewPost = function (post) {
	var _p0 = post;
	if (_p0.ctor === 'Blog') {
		return _user$project$PostTypes$viewBlogPost(_p0._0);
	} else {
		return _user$project$PostTypes$viewPicturePost(_p0._0);
	}
};
var _user$project$PostTypes$viewPostList = function (postList) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
		A2(_elm_lang$core$List$map, _user$project$PostTypes$viewPost, postList));
};
var _user$project$PostTypes$BlogPost = F2(
	function (a, b) {
		return {title: a, content: b};
	});
var _user$project$PostTypes$PicturePost = F2(
	function (a, b) {
		return {url: a, title: b};
	});
var _user$project$PostTypes$Picture = function (a) {
	return {ctor: 'Picture', _0: a};
};
var _user$project$PostTypes$Blog = function (a) {
	return {ctor: 'Blog', _0: a};
};

var _user$project$PostHttp$picturePostDecoder = A3(
	_elm_lang$core$Json_Decode$object2,
	_user$project$PostTypes$PicturePost,
	A2(_elm_lang$core$Json_Decode_ops[':='], 'url', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'title', _elm_lang$core$Json_Decode$string));
var _user$project$PostHttp$blogPostDecoder = A3(
	_elm_lang$core$Json_Decode$object2,
	_user$project$PostTypes$BlogPost,
	A2(_elm_lang$core$Json_Decode_ops[':='], 'title', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'content', _elm_lang$core$Json_Decode$string));

var _user$project$Tests$singleBlogPost = {title: 'This is my first blog', content: 'bla bla'};
var _user$project$Tests$singleBlogPostString = '\n{\"title\": \"blog\", \"title\": \"This is my first blog\", \"content\": \"bla bla\"}\n';
var _user$project$Tests$singlePicturePost = {url: 'IMG_20151224_082023.jpg', title: ''};
var _user$project$Tests$singlePicturePostString = '\n{\"type\": \"image\", \"url\": \"IMG_20151224_082023.jpg\", \"title\": \"\"}\n';
var _user$project$Tests$tests = A2(
	...
	_elm_lang$core$Native_List.fromArray(
		[
			...
			'decoder line picturepost',
			A2(
				_elm_community$elm_test$ElmTest$assertEqual,
				A2(_elm_lang$core$Json_Decode$decodeString, _user$project$PostHttp$picturePostDecoder, _user$project$Tests$singlePicturePostString),
				_elm_lang$core$Result$Ok(_user$project$Tests$singlePicturePost))),
			A2(
			_elm_community$elm_test$ElmTest$test,
			'decoder line blogpost',
			A2(
				_elm_community$elm_test$ElmTest$assertEqual,
				A2(_elm_lang$core$Json_Decode$decodeString, _user$project$PostHttp$blogPostDecoder, _user$project$Tests$singleBlogPostString),
				_elm_lang$core$Result$Ok(_user$project$Tests$singleBlogPost)))
		]));
